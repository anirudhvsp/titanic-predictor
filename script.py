...
def result():
   if request.method == 'POST':
      ...
      if(percent==0/6):
      	prob="Impossible Survival odds"
      elif(percent==1/6):
      	prob="Survival is Very Unlikely"
      elif(percent==2/6):
      	prob="Survival is Unlikely"
      elif(percent==3/6):
      	prob="Moderate chance of survival"
      elif(percent==4/6):
      	prob="Survival is likely"
      elif(percent==5/6):
      	prob="Survival is Very likely"
      else:
      	prob="Survival is Certain"
